...
Smart home: smart_home_devices to find entity ids, smart_home_control for everyday devices; locks, alarms and garage/doors go through smart_home_security, which the user confirms. If Home Assistant isn't set up, say so once.
